...
{
    public partial class VisorIncidenciasPorEmpleado : Form
    {
        String f1 = "", f2 = "";
        ...
        private void Cargar()
        {
            ...
            try
            {
                REP.IncidenciasPorEmpleado oReporte = new REP.IncidenciasPorEmpleado();
        ...
        public VisorIncidenciasPorEmpleado()
        {
            InitializeComponent();
