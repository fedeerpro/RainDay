...
{
    public partial class VisorIncidenciasPorTecnico : Form
    {
        String f1 = "", f2 = "";
        ...
        private void Cargar()
        {
            ...
            try
            {
                REP.IncidenciasPorTecnicos oReporte = new REP.IncidenciasPorTecnicos();
        ...
        public VisorIncidenciasPorTecnico()
        {
            InitializeComponent();
