...
{
    public sealed class SesionTecnico
    {
        private static SesionTecnico instance = null;
        ...
        public static SesionTecnico Instance
        {
            get
            {
                if (instance == null)
